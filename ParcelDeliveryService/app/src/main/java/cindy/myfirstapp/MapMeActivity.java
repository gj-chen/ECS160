...
public class MapMeActivity extends FragmentActivity implements ConnectionCallbacks, OnConnectionFailedListener {
    private GoogleApiClient mGoogleApiClient;

    // tracks whether the app is already resolving an error or not
